...
public partial class user_userhome : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT distinct(moviename), movieimage FROM tbassignmovie where dateavailable > getdate() GROUP BY moviename, movieimage", con);
